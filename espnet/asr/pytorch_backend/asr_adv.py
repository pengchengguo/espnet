...
class CustomUpdater(StandardUpdater):
    ...
    def update_core(self):
        ...
        # TODO: support multiple GPUs and DistributedDataParallel
        assert self.ngpu == 1
...
def train(args):
    ...
    if args.adv_type == "freelb":
        from espnet.nets.pytorch_backend.adv_training.freelb import FreeLB
        ...
        adversary = FreeLB(
            ...
            adv_init_bound=args.adv_init_bound,
