...
# from espnet.nets.pytorch_backend.e2e_asr_mix_conditional import DecoderConditional
...
class E2E(E2EASR, ASRInterface, torch.nn.Module):
    ...
    def __init__(self, idim, odim, args, ignore_id=-1):
        ...
        # self.encoder_condition = DecoderConditional(
        #     eprojs=self.eunits,
        #     odim=odim,
        #     dtype="lstm",
        #     dlayers=args.elayers_cond,
        #     dunits=args.eunits_cond,
        #     eos=self.eos,
    ...
    def recognize(
        ...
        for ns in range(num_spkrs):
            nbest_hyps_single, alignment, prev_states = self.recognize_for_one_spkr_v2(
                enc_output,
                enc_len,
                alignment,
                recog_args,
