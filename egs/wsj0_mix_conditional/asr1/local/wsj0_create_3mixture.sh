...
## Change some path manunally
# sed -i -e "s=wsj0root \= \'\./\'=wsj0root \= \'${wsj_full_wav}\'=" \
#        -e "s=\./data/3speakers=${wsj_3mix_wav}=" \
#        -e "s='min','max'='max'=" \
#        ${dir}/create_wav_3speakers.m

# echo "WSJ0 wav file."
# local/convert2wav.sh ${wsj0_path} ${wsj_full_wav} || exit 1;

echo "Creating 3 Mixtures."

# matlab_cmd="matlab -nojvm -nodesktop -nodisplay -nosplash -r create_wav_3speakers"
matlab_cmd="/home/work_nfs/common/matlab/2014b/bin/matlab -nojvm -nodesktop -nodisplay -nosplash -r create_wav_3speakers"

mixfile=${dir}/mix3_matlab.sh
...
# Run Matlab
cd ${dir}
$train_cmd ${dir}/mix3.log $mixfile
